...
namespace CFB_Academia
{
    public partial class F_GestaoProfessores : Form
    {
        ...
        private void btn_salvar_Click(object sender, EventArgs e)
        {
            ...
            if (tb_id.Text =="")
            {
                vquery = "INSERT INTO (T_NOMEPROFESSOR, T_TELEFONE) VALUES ('"+tb_nome.Text+"','"+mtb_telefone.Text+"')";
            }
            else
            {
                vquery = "UPDATE SET T_NOMEPROFESSOR='" + tb_nome.Text + "', T_TELEFONE='" + mtb_telefone.Text + "' WHERE N_IDPROFESSOR=" + tb_id.Text;
            }
            Banco.dml(vquery);
            vquery = @"
                SELECT
